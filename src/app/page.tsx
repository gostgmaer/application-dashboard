        ...
        <section className="py-16 md:py-24 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A comprehensive authentication system with multi-step
              registration, secure login, and full user management capabilities.
            </p>
        ...
        <section className="py-16 border-t">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Our authentication system provides everything you need for secure
              user management
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Multi-step registration process that collects all necessary user
                information while maintaining a smooth user experience.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                ...
                two-factor authentication, and secure token handling.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Simple and secure password recovery flow with email verification
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Verify user emails to ensure authentic registrations and reduce
                spam accounts.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Switch between light, dark, and system-preferred themes for
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Robust form validation using Yup schema validation to ensure
        ...
        <section className="py-16 border-t">
          <div className="bg-card rounded-xl p-8 md:p-12 shadow-sm">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="text-muted-foreground">
                Create your account now and experience our comprehensive
