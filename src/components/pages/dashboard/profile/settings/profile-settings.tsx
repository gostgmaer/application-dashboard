...
import { User, Camera, Mail, Phone, CircleCheck as CheckCircle, Circle as XCircle, Send, Loader as Loader2, Shield } from 'lucide-react';
      ...
      <Card className="border-0 shadow-sm bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {user.dateOfBirth ? format(new Date(user?.dateOfBirth), 'MMM dd, yyyy') : 'Not specified'}
                  </span>
                </div>
            ...
            {/* Verification Status */}
            <div className="space-y-4">
              <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Verification Status</h4>
