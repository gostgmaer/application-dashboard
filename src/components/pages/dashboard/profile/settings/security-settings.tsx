...
export function SecuritySettings() {
  ...
  const setupSmsOtp = async (data: PhoneForm) => {
    ...
    try {
      // const response = await userApi.setupSmsOtp(data.phoneNumber);
      // if (response.success) {
  ...
  const enableSmsOtp = async () => {
    ...
    try {
      // const response = await userApi.sendOtp('sms', user.phone);
      // if (response.success) {
      //   setCurrentOtpType('sms');
      //   setOtpSent(true);
      //   setResendCooldown(60);
  ...
  const disableSmsOtp = async () => {
    ...
    try {
      // const response = await userApi.toggleOtpMethod('sms', false);
      // if (response.success) {
  ...
  const enableEmailOtp = async () => {
    ...
    try {
      // const response = await userApi.sendOtp('email', user?.email);
      // if (response.success) {
  ...
  const disableEmailOtp = async () => {
    ...
    try {
      // const response = await userApi.toggleOtpMethod('email', false);
      // if (response.success) {
  ...
  const verifyOtp = async (data: OTPVerificationForm) => {
    ...
    try {
      // const response = await userApi.verifyOtp(currentOtpType!, data.otp);
      // if (response.success) {
